                ...
                <div className="grid grid-cols-1 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-lg border border-yellow-500 bg-black text-white ${
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 rounded-lg border border bg-black text-white ${
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`w-full px-4 py-3 rounded-lg border bg-black text-white ${
